...
{
	if (is_admin()) {
		wp_enqueue_style( 'dashboard', plugins_url( 'forge-customisations/css/dashboard.css' ), array(), '1.0' );
...
function forge_login_css() {
    echo '<link rel="stylesheet" type="text/css" href="' . plugins_url( 'forge-customisations/css/wp-login.css' ) . '">';
}
